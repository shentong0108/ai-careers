---
title: "Why I Killed My Nurse-Tooling Side Project Before Coding"
...
voicePolisherSamples: ["src/content/posts/dev-diary/aura-week-1-with-an-ai-coding-tool.mdx", "src/content/posts/nurse-ai/ai-assisted-nursing-handoff-notes.mdx"]
---
...
See also: [the AI-assisted nursing notes tool I did build (and its one near-miss)](/blog/ai-assisted-nursing-handoff-notes) · [the side project I killed on day 14](/blog/aura-week-1-with-an-ai-coding-tool) · [structuring documentation with AI without piping in regulated data](/blog/documenting-child-learning-observations-with-ai-assist-witho)
