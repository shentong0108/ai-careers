---
title: "Aura week 1: I killed my voice-first ECE app on day 14"
slug: "aura-week-1-claude-code"
description: "Two weeks. 60 commits. One 4-hour bubble bug. Then I killed the project. What Claude Code got right, and what I should have checked first."
publishedAt: "2026-05-26"
updatedAt: "2026-05-26"
author: "stone"
category: "dev-diary"
tags: ["claude code", "indie dev", "post-mortem", "voice-first", "ECE tech"]
keywords: ["claude code review", "claude code workflow", "voice-first PWA", "indie hacker failure", "competitor research timing", "Sydney indie dev"]
canonical: "https://stonemegan.dev/blog/aura-week-1-claude-code"
draft: false
aiDetectionScore: null
heroImage: "/images/aura-week-1-hero.svg"
factChecked: false
factCheckNotes: []
---
...
1. [Mana announced a "Live" voice-first feature for autumn 2026](https://www.makemana.com/blog/2026-autumn-launch). That's Aura's USP. Already shipping.
2. [Early Edu AI is at $8.99/month for individual educators](https://earlyedu.ai/pricing-detail.html), with a stated 1,000+ subscribers. The single-educator long-tail I assumed was unserved is not.
3. [Mana / LoveHeart has SOC2 and a public trust center](https://trust.loveheart.ai). They're already on the Australian Childcare Alliance's official AI-partner list.
