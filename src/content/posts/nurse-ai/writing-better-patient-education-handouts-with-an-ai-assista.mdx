...
voicePolisherSamples: ["src/content/posts/nurse-ai/claude-nursing-handoff-notes.mdx", "src/content/posts/dev-diary/why-i-killed-my-first-nurse-tooling-project-before-i-wrote-a.mdx"]
---
...
If you want the adjacent pieces of this workflow, see my notes on discharge instructions, the teach-back method, and how I handle [AI-assisted nursing handoff notes](/blog/claude-nursing-handoff-notes).
